...
| Phase 3 eval perf gate | **p50 0.509 ms / p99 0.995 ms** on 10k fuzz; target is <10 ms / <50 ms |
| Phase 3 E2E | **16/16 pass, 1 SKIP** (`BASE_RPC_URL` fork replay self-skip) |
| Unit tests touched by Merkle/eval/reducer | **97/97 pass** (Merkle/eval/patch/reducer/live-epoch/legacy bonus) |
...
| Phase 7 synthetic E2E | **7/7 pass** including baseline validity + live mid-epoch advance semantics |
...
1. Run Phase 7 real baseline iteration (`experiments/PHASE_7_USER_ACTIONS.md`).
