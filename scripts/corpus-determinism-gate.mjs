 ...
 *   3. deriveQueryPack(epochId, evalSeed, corpus, canonical hiddenPack) is stable
...
const { computeCorpusRoot, deriveQueryPack, verifyQueryPack, packFamilyCounts, packQuotaCoverage, keccak256, bytesToHex, hiddenPackProfileFromEvaluatorProfile } = m;
...
const pack1 = deriveQueryPack(epoch, evalSeedHex, a.corpus, hiddenPack);
const pack2 = deriveQueryPack(epoch, evalSeedHex, b.corpus, hiddenPack);
...
const vp = verifyQueryPack(pack1, a.corpus, hiddenPack);
...
const coverage = packQuotaCoverage(pack1, hiddenPack);
