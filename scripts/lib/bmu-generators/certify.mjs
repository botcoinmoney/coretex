/**
 * BMU P2 hardness-certification harness (shared across the four family lanes,
 ...
 *
 * Usage:
 *   node scripts/lib/bmu-generators/certify.mjs \
...
if (isMain) {
  ...
  if (!args.bank || !args.out) {
    console.error('usage: certify.mjs --bank <sample-bank.json> --out <certification.json> [--real-lane <json>] [--seed <s>] [--budget-override <n>]');
    process.exit(2);
  }
