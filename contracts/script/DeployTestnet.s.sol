...
/// @notice Deploy CortexRegistry and stale CoreTexMergeBonus to a testnet.
///
...
contract DeployTestnet is Script {
    function run() external {
        ...
        console2.log("=== CortexRegistry + stale CoreTexMergeBonus -- TESTNET DEPLOY ===");
        ...
        // 2. Deploy stale CoreTexMergeBonus (no-uplift compatibility rail)
