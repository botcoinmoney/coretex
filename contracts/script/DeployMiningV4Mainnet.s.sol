...
///   BOTCOIN_TOKEN=0x...
///   BOTCOIN_MINING_V3=0x...
///   CORETEX_REGISTRY=0x...
///   COORDINATOR_SIGNER=0x...
/// Optional:
...
contract DeployMiningV4Mainnet is Script {
    function run() external {
        ...
        address v3 = vm.envAddress("BOTCOIN_MINING_V3");
        address registry = vm.envAddress("CORETEX_REGISTRY");
        address coordinator = vm.envAddress("COORDINATOR_SIGNER");
        ...
        console2.log("BOTCOIN_TOKEN:", botcoin);
        console2.log("BOTCOIN_MINING_V3 stake source:", v3);
        console2.log("CORETEX_REGISTRY:", registry);
        console2.log("COORDINATOR_SIGNER:", coordinator);
        ...
        console2.log(
            "NEXT: call CoreTexRegistry.addCoordinator(BotcoinMiningV4) from registry owner before first CoreTex state advance."
        );
    }
}
