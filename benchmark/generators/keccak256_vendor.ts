...
// Each entry is [hi_word, lo_word]. Standard Keccak RC values; matches the
// fixed packages/cortex/src/state/keccak256.ts after PR #9 cross-impl audit.
...
// (column-major lane addressing). RHO[i] = rotation count for lane at flat
// position i. Standard Keccak construction.
...
export function keccak256(data: Uint8Array): Uint8Array {
  ...
  for (let i = 0; i < 4; i++) {
    const lane = i;  // lanes are contiguous (was: i*2 — broken; matches PR #9 fix)
