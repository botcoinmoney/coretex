"""
Tests for coretex_py.patch — LEB128, encode/decode, apply_patch with E01..E05.
"""
import pytest
import random
from coretex_py.patch import (
    encode_leb128, decode_leb128,
    encode_patch, decode_patch,
    apply_patch,
)
from coretex_py.types import CortexState, Patch, RANGES, PATCH_TYPE
from coretex_py.merkle import merkleize_state
