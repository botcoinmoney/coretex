"""
Tests for coretex_py.validate — reserved-bit enforcement.
"""
import pytest
from coretex_py.validate import has_non_zero_reserved_bits, RESERVED_MASKS
from coretex_py.types import CortexState, RANGES
