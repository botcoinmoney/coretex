...
describe('CoreTex V4 difficulty calculator', () => {
  ...
  test('clamp overrides default to pinned constants when undefined / non-sensible', () => {
    ...
    const b = nextMinImprovementPpm({ current: 149_000n, observedAdvances: 10, targetAdvances: 5, qualityAttempts: 8, maxClampPpm: 400n });
    assert.equal(b.next, MAX_IMPROVEMENT_PPM); // 400 < floor → ignored
