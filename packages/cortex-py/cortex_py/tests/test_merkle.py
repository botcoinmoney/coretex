"""
Tests for cortex_py.merkle — Merkle root derivation.
"""
import pytest
from cortex_py.merkle import merkleize_state, bytes_to_hex, hex_to_bytes
...
def test_leaf_encodes_word_big_endian():
    ...
    """
    from cortex_py.merkle import _leaf
