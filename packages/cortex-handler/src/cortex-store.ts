/**
 * cortex-store.ts — cross-lane bookkeeping on the SWCP coordinator side.
 *
 * Tracks:
 ...
 *
 * §13.4 plug-and-play guarantee: this file is imported only by cortex-handler.
...
const DEFAULT_STORE_PATH = 'data/coordinator/cortex-store.db';
