 ...
 *
 * Reads CORTEX_STORE_DB_PATH env (default: data/coordinator/cortex-store.db).
 * Applies all SQL files in packages/cortex-handler/migrations/ in version order.
...
const DEFAULT_DB = 'data/coordinator/cortex-store.db';
